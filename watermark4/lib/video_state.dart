...
class _VideoState extends State<VideoState> {
  ...
  final double _rotationAngle =
      -(90 * 3.1416 / 180); // Ângulo de rotação inicial
    ...
    setState(() {
      ...
      _videoController = VideoPlayerController.file(_video!)
        ..initialize().then((_) {
          ...
          _videoController!
              .play(); // Reproduz o vídeo automaticamente após a inicialização
        });
    });
  }
  ...
  void _onVideoTapped() {
    ...
    setState(() {
      if (_videoController!.value.isPlaying) {
        ...
        _videoController!
            .seekTo(Duration.zero); // Reinicia o vídeo se ele tiver terminado
